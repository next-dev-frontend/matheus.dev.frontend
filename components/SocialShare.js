    ...
    <div className="flex items-center w-max max-w-full fixed left-0 bottom-0 z-40">
      ...
      {isVisible && (
        ...
        <button
          ...
          onMouseEnter={handleHoverSocial}
      ...
      {isVisible && (
        <div className={`${open ? "flex" : "hidden"} flex-col pl-1.5 md:pl-24 pb-32 md:pb-12`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 w-full border-2 border-gray-100 rounded-md gap-2 p-2 items-center justify-center bg-indigo-900 bg-opacity-80 shadow-md relative">
            {/* :::twitter */}
            <a href="#twitterlink" target="_blank" onMouseEnter={handleHoverSocial} onClick={() => { setOpen(!open); handleClickSocial() }} className="w-16 h-16 inline-flex justify-center items-center bg-[#1DA1F2] hover:opacity-80" style={{ backgroundColor: "#1DA1F2" }}>
            ...
            {/* :::facebook */}
            <a href="#facebooklink" target="_blank" onMouseEnter={handleHoverSocial} onClick={() => { setOpen(!open); handleClickSocial() }} className="w-16 h-16 inline-flex justify-center items-center bg-[#4267B2] hover:opacity-80" style={{ backgroundColor: "#4267B2" }}>
            ...
            {/* :::google */}
            <a href="#googlelink" target="_blank" onMouseEnter={handleHoverSocial} onClick={() => { setOpen(!open); handleClickSocial() }} className="w-16 h-16 inline-flex justify-center items-center bg-[#DB4437] hover:opacity-80" style={{ backgroundColor: "#DB4437" }}>
            ...
            {/* :::email */}
            <a href="#maillink" target="_blank" onMouseEnter={handleHoverSocial} onClick={() => { setOpen(!open); handleClickSocial() }} className="w-16 h-16 inline-flex justify-center items-center bg-yellow-400 hover:opacity-80">
            ...
            {/* :::copy link */}
            <button target="_blank" onMouseEnter={handleHoverSocial} onClick={() => { setOpen(!open); handleClickSocial() }} className="w-16 h-16 inline-flex justify-center items-center bg-gray-700 hover:opacity-80">
