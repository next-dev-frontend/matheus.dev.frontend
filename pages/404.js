export default function page404() {
  return (
    <section id="page404" className="select-none relative flex flex-wrap flex-shrink md:flex-shrink-0 items-center justify-center m-auto bg-no-repeat w-full max-w-full h-screen">
      <div className="absolute grid h-screen place-content-center w-full max-w-full bg-gray-200 bg-opacity-70">
        <div className="text-center">
          <strong className="text-9xl font-black text-purple-600">404</strong>
          <p className="mt-4 text-indigo-600 pb-8">Página não encontrada.</p>
